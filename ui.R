  ...
  navbarPage(id = 'mainPage',
             ...
             tabPanel(id = "single",
                      ...
                      column(9, wellPanel(tags$span(tags$b(tags$p("NOTE: GTagHD will only process a single job at a time, regardless of the number of browser windows open. You should download the results of a job before submitting another. See FAQs for more information.", style="color:blue;"))),
                                          tags$span(tags$b("Please see the ", 
                                                           tags$span(tags$a(href="GeneWeldProtocol09-09-2024.pdf", target="_blank", "GeneWeld protocol", style="color:black;")), 
                      ...
                      column(9, wellPanel(
                        ...
                        wellPanel(
                          ...
                          radioButtons("sense",
                                       ...
                                       choices = c("Reverse strand (antisense strand)"    = 1,      #July 2021 fix
                                                   "Forward strand (sense strand)" = 0),
                                       selected = 0,
                                       inline = TRUE)
                        ),
             ...
             tabPanel(
               ...
               wellPanel(
                 ...
                 tags$p("Click", tags$a(href="GeneWeldProtocol09-09-2024.pdf", target="_blank", "here"), "to download the GeneWeld protocol.")
               ),  
